...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['ta bien', 0.7], //69%
		['wena', 0.8], //From 70% to 79%
		['pulento', 0.9], //From 80% to 89%
		['wn bueno', 1], //From 90% to 99%
		['CULIAO SECO', 1] //The value on this one isn't used actually, since Perfect is always "1"
	]; 
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			case 'consentida' | 'asereje':
				...
				var bg:BGSprite = new BGSprite('unimarc/Back', -1040, -630, 0.95, 0.95);
